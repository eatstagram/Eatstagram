...
class LoginViewController: UIViewController {
    ...
    fileprivate func performLogin() {
        ...
        Auth.auth().signIn(withEmail: email, password: password) { (result, error) in
            ...
            //let uploadViewController = storyBoard.instantiateViewController(withIdentifier: "feedViewController") as! FeedViewController
            //let uploadViewController = storyBoard.instantiateViewController(withIdentifier: "userViewController") as! UserViewController
            let tabBarController = storyBoard.instantiateViewController(withIdentifier: "tabBarController")
            //let navController = UINavigationController(rootViewController: homeNavController)
